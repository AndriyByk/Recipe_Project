...
//                .antMatchers(HttpMethod.GET,"/*").hasAnyRole("USER")
                ...
                .and()
                // якшо урла, на яку заходимо є "/sign-in", то будується токен
                ...
                .addFilterBefore(new SignInFilter("/sign-in", authenticationManager(), tokenBuilderService, userService), UsernamePasswordAuthenticationFilter.class)
                ...
                .addFilterBefore(new RequestsProcessingFilter(authTokenDAO, userDAO), UsernamePasswordAuthenticationFilter.class)
